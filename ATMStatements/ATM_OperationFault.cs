...
{
    ///<inheritdoc/>
    ///<remarks>Класс, устанавливающий поведение элементов управления при попытки снятия средств кода банкомат польностью пуст</remarks>
    class ATM_OperationFault : ATMState
    {
        public ATM_OperationFault(ATM_UI atm_UI) : base(atm_UI)
        {
        }
        ...
        ///<inheritdoc/>
        ///<remarks>Метод возвращает банкомат в состояние выбора операций.</remarks>
