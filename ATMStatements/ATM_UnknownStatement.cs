...
{
    ///<inheritdoc/>
    ///<remarks>Класс, устанавливающий поведение элементов управления при неопределенном состоянии (класс заглушка)</remarks>
    class ATM_UnknownStatement : ATMState
    {
        public ATM_UnknownStatement(ATM_UI atm_UI) : base(atm_UI)
        {
        }
