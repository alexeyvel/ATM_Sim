...
{
    ///<inheritdoc/>
    ///<remarks>Класс, устанавливающий поведение элементов управления при операции снятия денег со счета, когда сумма введенная пользователем не кратна купюрам в банкомате</remarks>
    class ATM_WithdrawCashFailure2 : ATMState
    {
        public ATM_WithdrawCashFailure2(ATM_UI atm_UI) : base(atm_UI)
        {
        }
