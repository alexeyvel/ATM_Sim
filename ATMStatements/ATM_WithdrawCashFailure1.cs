...
{
    ///<inheritdoc/>
    ///<remarks>Класс, устанавливающий поведение элементов управления при операции снятия денег со счета, когда у пользователя недостаточно средств</remarks>
    class ATM_WithdrawCashFailure1 : ATMState
    {
        public ATM_WithdrawCashFailure1(ATM_UI atm_UI) : base(atm_UI)
        {
        }
